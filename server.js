...
if(results['Wi-Fi']!=undefined){
    ...
    var servermain=results['Ethernet'][0];
}
...
app.post('/signup',function(req,res){
    ...
    form.parse(req, function (err, fields, files) {
        ...
        var newpath = 'E:/nodeJs/sneaky/images/' + files.files.file_name;
        // fs.rename(oldpath, newpath, function (err) {
        //     console.log(err);
        // });
        ...
        var filename=files.files.file_name;
...
app.get('/profile_page',async(req,res)=>{
    ...
    detailss=await userdetails(req.session.user_id);   
    res.render('profile_settings.ejs',{user_picture:user_picture,detailss:detailss,sessioned_id:req.session.user_id,servermain:servermain});
})
